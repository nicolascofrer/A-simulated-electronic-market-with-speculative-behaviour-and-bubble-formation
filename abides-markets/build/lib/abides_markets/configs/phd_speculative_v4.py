...
def build_config(
    ...
    megashock_lambda_a=1/(str_to_ns("90s")),
    ...
    #mm_price_skew=0,
    mm_level_spacing=5,
    mm_spread_alpha=0.95,
    mm_backstop_quantity=0,
    mm_cancel_limit_delay=50,  # 50 nanoseconds
    mm_poisson_arrival = False,
    # 5) Momentum Agents
    num_momentum_agents=0,
    # num_momentum_agents=100,
    
    num_speculative_agents=300,
    agents_wake_up_freq = str_to_ns("30s")
):
    """
    ...
    print("build version 15-02-2023")
    # fix seed
    np.random.seed(seed)
    ...
    agents.extend(
        [
            AdaptiveMarketMakerAgent(
                ...
                poisson_arrival=mm_poisson_arrival,
